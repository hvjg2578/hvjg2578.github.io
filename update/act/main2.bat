...
if %errorlevel%==10 call toolbox.bat
goto :loop
:ml
cls
echo.                             
...
::exit
:job16
@title 系统装机全能工具箱- office2016 / 365
setlocal EnableDelayedExpansion&color 3f & cd /d "%~dp0"
title 系统装机全能工具箱-Office 2016 / 365
...
:job5
cls
title 系统装机全能工具箱-Windows Server 2012 
echo.
echo.     当前系统为%sysinfo%
echo.
echo.   选择你的系统版本
...
:job6
cls
title 系统装机全能工具箱-Windows Server 2012 R2 
echo.
echo.  当前系统为%sysinfo%
echo.
echo.   选择你的系统版本
...
:job7
cls
title 系统装机全能工具箱-Windows Server 2008 
echo.
echo.  当前系统为%sysinfo%
echo.
echo.   选择你的系统版本
...
:job8
cls
title 系统装机全能工具箱-Windows Server 2008 R2 
echo.
echo.     当前系统为%sysinfo%
echo.
echo.   选择你的系统版本
...
:ser2016
cls
title 系统装机全能工具箱-Windows Server 2016
echo.
echo.  当前系统为%sysinfo%
echo.
echo.   选择你的系统版本
...
echo.
echo.    1.在office安装激活完毕前，不要退出本程序，否则会导致安装或激活失败
echo.    2.如果office安装过程中出现错误，请关闭本窗口并重新安装
